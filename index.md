...
features:
  ...
  - title: 3D可视化展示
    ...
    icon: 🎯
  - title: 工单与故障管理
    details: 完整的工单流转流程，支持故障分类、优先级管理、统计分析、工单趋势图，保障运维效率。
    icon: 📋
  - title: 耗材库存管理
    details: 耗材入库出库管理、安全库存预警、SN序列号追踪、领用记录与SVG环形图统计报表。
    icon: 📦
  - title: 资产盘点
  ...
  - title: 操作审计日志
    ...
    icon: 📝
  - title: 网络拓扑可视化
    details: 基于ReactFlow的网络拓扑图，支持设备间连接关系展示、拓扑布局持久化、线缆类型与状态着色。
    icon: 🔗
  - title: 权限管理体系
    details: 基于RBAC的三级权限模型（模块→菜单→按钮），支持自定义角色与细粒度权限分配。
    icon: 🔐
  - title: 系统管理
    details: 用户角色权限管理、系统参数配置、CPU/内存/数据库实时监控，保障系统安全可控。
    icon: ⚙️
  - title: 双授权模式
    details: GPL-3.0 开源 + 商业授权双通道，开源免费使用，商业闭源二次开发需获取商业授权。
    icon: 📜
---
